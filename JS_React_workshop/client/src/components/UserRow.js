import { dateToString } from "../utils/dateParser";
 ...
 return (
    ...
    <td>{dateToString(props.user.createdAt)}</td>

    <td className="actions">
        <button className="btn edit-btn" title="Edit" onClick={()=>props.openAddUserForm(props.user._id)}>
        ...
        <button className="btn delete-btn" title="Delete" onClick={()=>props.openDeleteUserForm(props.user._id)}>
        ...
        <button className="btn info-btn" title="Info" onClick={()=>props.getInfo(props.user._id)}>
